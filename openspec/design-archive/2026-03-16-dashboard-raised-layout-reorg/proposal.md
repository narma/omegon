...
See [Raised dashboard layout reorganization — design-dominant workspace and contextual implementation rail design doc](../../../docs/dashboard-raised-layout-reorg.md) for full context.
