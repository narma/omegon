...
task_id: 0
label: hotkeys
siblings: [1:editor-chrome, 2:conversation-chrome]
---
...
Add TUI hotkeys for UI posture switching, including fast access to /ui full and /ui slim, with tests covering the new keybindings and state transitions.
